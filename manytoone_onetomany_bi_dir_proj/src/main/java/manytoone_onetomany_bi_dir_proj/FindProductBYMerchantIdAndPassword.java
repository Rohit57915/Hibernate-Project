...
public class FindProductBYMerchantIdAndPassword {
	public static void main(String[] args) {
		  ...
		  Query q=man.createQuery("Select m.product from Merchant m Where m.id=?1 and m.password=?2");
		  ...
		  {
			 System.err.println("NO Product Found since the Merchant Id and Password is Wrong "); 
		  }
	}
}
